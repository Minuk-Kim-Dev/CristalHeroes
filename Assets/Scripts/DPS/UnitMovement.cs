...
public class UnitMovement : MonoBehaviour
{
    ...
    public void GoEnemy()
    {
        arrived = false;
        only_move = false;
        TargetTR = new Vector2Int((int)dps_fsm.target.gameObject.transform.position.x, (int)dps_fsm.target.gameObject.transform.position.y);
        targetPos = Vector2Int.RoundToInt(TargetTR);
    }
    ...
    //private Vector2Int EmptyPathfinding(Vector2Int goal)
    //{
    //    int isEmpty = 0;
    //    Vector2Int notEmptyPos;
    //    Vector2Int newGoal;
    //    for (int i = 0; i < gameManager.GetComponent<GameManager>().unitPos.Count; i++)
    //    {
    //        notEmptyPos = new Vector2Int((int)gameManager.GetComponent<GameManager>().unitPos[i].GetComponent<Transform>().position.x, (int)gameManager.GetComponent<GameManager>().unitPos[i].GetComponent<Transform>().position.y);
    //        if (notEmptyPos == goal)
    //            isEmpty++;
    //    }
    //    if (isEmpty == 0)
    ...
    //    else
    //    {
    //        newGoal = new Vector2Int(goal.x, goal.y + 3);
    //        return newGoal;
    //    }
    //}
}
