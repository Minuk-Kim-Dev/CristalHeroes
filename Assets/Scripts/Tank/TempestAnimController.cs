...
public class TempestAnimController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (unit.newChar == false && arrived == false && unit.die == false)
        {
            ...
            {
                changeAnim = "tempest_sf/tempest_sf_run";
                if (SameAnimation(currentAnim, changeAnim))
                {
                    skeletonAnimation.Skeleton.SetSkin("tempest_sf");
            ...
            {
                changeAnim = "tempest_f/tempest_f_run";
                if (SameAnimation(currentAnim, changeAnim))
                {
                    skeletonAnimation.Skeleton.SetSkin("tempest_f");
                    skeletonAnimation.Skeleton.SetSlotsToSetupPose();
                    skeletonAnimation.AnimationState.SetAnimation(0, changeAnim, true);
                }
                if (xScale < 0) { ReverseScale(); }
            ...
            {
                changeAnim = "tempest_b/tempest_b_run";
                if (SameAnimation(currentAnim, changeAnim))
                {
                    skeletonAnimation.Skeleton.SetSkin("tempest_b");
                    skeletonAnimation.Skeleton.SetSlotsToSetupPose();
                    skeletonAnimation.AnimationState.SetAnimation(0, changeAnim, true);
                }
                if (xScale < 0) { ReverseScale(); }
            ...
            {
                changeAnim = "tempest_sb/tempest_sb_run";
                if (SameAnimation(currentAnim, changeAnim))
                {
                    skeletonAnimation.Skeleton.SetSkin("tempest_sb");
                    skeletonAnimation.Skeleton.SetSlotsToSetupPose();
                    skeletonAnimation.AnimationState.SetAnimation(0, changeAnim, true);
                }
                if (xScale > 0) { ReverseScale(); }
        ...
        {
            if (currentSkin == "tempest_f")
            {
                changeAnim = "tempest_f/tempest_f_idle";
                if (SameAnimation(currentAnim, changeAnim))
                {
                    skeletonAnimation.AnimationState.SetAnimation(0, changeAnim, true);
                }
            }
            else if (currentSkin == "tempest_sf")
            {
                changeAnim = "tempest_sf/tempest_sf_idle";
                if (SameAnimation(currentAnim, changeAnim))
                {
                    skeletonAnimation.AnimationState.SetAnimation(0, changeAnim, true);
                }
            }
            else if (currentSkin == "tempest_b")
            {
                changeAnim = "tempest_b/tempest_b_idle";
                if (SameAnimation(currentAnim, changeAnim))
                {
                    skeletonAnimation.AnimationState.SetAnimation(0, changeAnim, true);
                }
            }
            else if (currentSkin == "tempest_sb")
            {
                changeAnim = "tempest_sb/tempest_sb_idle";
                if (SameAnimation(currentAnim, changeAnim))
                {
                    skeletonAnimation.AnimationState.SetAnimation(0, changeAnim, true);
                }
        ...
        {
            changeAnim = "tempest_sf/tempest_sf_die";
            ...
            if (SameAnimation(currentAnim, changeAnim))
            {
                skeletonAnimation.Skeleton.SetSkin("tempest_sf");
                skeletonAnimation.Skeleton.SetSlotsToSetupPose();
                skeletonAnimation.AnimationState.SetAnimation(0, "tempest_sf/tempest_sf_die", false);
            }
        }
        ...
        if (unit.newChar == false && fsm.fight == true && fsm.currentTime >= 0.7f && fsm.currentTime <= 1.5f)
        {
            ...
            if (unit.die == false && arrived == true && attackMotion == 1 && fsm.fight == true)
            {
                ...
                if (playerPos.x > targetPos.x && playerPos.y == targetPos.y)
                {
                    changeAnim = "tempest_sf/tempest_sf_attack_2";
                    if (SameAnimation(currentAnim, changeAnim))
                    {
                        skeletonAnimation.Skeleton.SetSkin("tempest_sf");
                        skeletonAnimation.Skeleton.SetSlotsToSetupPose();
                        skeletonAnimation.AnimationState.SetAnimation(0, changeAnim, false);
                        skeletonAnimation.AnimationState.AddAnimation(0, "tempest_sf/tempest_sf_idle", true, 0);
                        attackMotion = UnityEngine.Random.Range(0, 2);
                    }
                    if (xScale < 0) { ReverseScale(); }
                }
                ...
                {
                    changeAnim = "tempest_sb/tempest_sb_attack_2";
                    if (SameAnimation(currentAnim, changeAnim))
                    {
                        skeletonAnimation.Skeleton.SetSkin("tempest_sb");
                        skeletonAnimation.Skeleton.SetSlotsToSetupPose();
                        skeletonAnimation.AnimationState.SetAnimation(0, changeAnim, false);
                        skeletonAnimation.AnimationState.AddAnimation(0, "tempest_sb/tempest_sb_idle", true, 0);
                        attackMotion = UnityEngine.Random.Range(0, 2);
                    }
                }
                else if (playerPos.x < targetPos.x && playerPos.y < targetPos.y)
            ...
            else if (unit.die == false && arrived == true && attackMotion == 0 && fsm.fight == true && target != null)
            {
                ...
                if (playerPos.x > targetPos.x && playerPos.y == targetPos.y)
                {
                    changeAnim = "tempest_sf/tempest_sf_attack_1";
                    if (SameAnimation(currentAnim, changeAnim))
                    {
                        skeletonAnimation.Skeleton.SetSkin("tempest_sf");
                        skeletonAnimation.Skeleton.SetSlotsToSetupPose();
                ...
                {
                    changeAnim = "tempest_sb/tempest_sb_attack_1";
                    if (SameAnimation(currentAnim, changeAnim))
                    {
                        skeletonAnimation.Skeleton.SetSkin("tempest_sb");
                        skeletonAnimation.Skeleton.SetSlotsToSetupPose();
        ...
        {
            changeAnim = "tempest_f/tempest_f_create";
            if (SameAnimation(currentAnim, changeAnim))
            {
                skeletonAnimation.Skeleton.SetSkin("tempest_f");
                skeletonAnimation.Skeleton.SetSlotsToSetupPose();
